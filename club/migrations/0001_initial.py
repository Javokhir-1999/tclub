# Generated by Django 4.1.4 on 2023-05-25 12:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('admin', 'Админ'), ('operator', 'Оператор')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='club.producttype')),
            ],
        ),
        migrations.AddField(
            model_name='product',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='club.productlist'),
        ),
        migrations.AddField(
            model_name='product',
            name='shipper',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='club.shipper'),
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
